...
date: '2022-10-25'
topics: ['responsive', 'image', 'srcset', 'sizes', 'html', 'attributes']
draft: false
...
<UnsplashPhotoInfo
  photoURL="https://unsplash.com/photos/TMa0l7fdSW8"
  author="Dang Cong"
/>
...
1. [Responsive images - Learn web development | MDN](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images)
