...
<UnsplashPhotoInfo
  photoURL="https://unsplash.com/photos/wbXdGS_D17U"
  author="Ilya Pavlov"
/>
...
<Twemoji emoji="light-bulb" /> I would highly recommend adding a `postinstall` script
in the **package.json** file to automatically install husky hooks after installing
dependencies:
